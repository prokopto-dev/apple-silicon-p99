...
All notable changes are recorded here. Through v0.4.0 this file was
hand-written in [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) form;
from the next release on it is generated by
[Python Semantic Release](https://python-semantic-release.readthedocs.io/) from
Conventional Commit messages. Versions are tags like `v0.4.0`, and each
release's section below becomes its GitHub Release notes automatically
